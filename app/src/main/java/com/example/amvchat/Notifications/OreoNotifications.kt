...
class  OreoNotifications (private val mContext: Context){
    ...
    companion object{
        private const val CHANNEL_ID = "com.example.amvchat"
        private const val CHANNEL_NAME = "AMV Chat"
    }
    init {
    ...
    fun getOreoNotification(title: String?,
        ...
        return Notification.Builder(mContext.applicationContext, CHANNEL_ID)
